        ...
        <section class="card">
            <div class="card-body text-secondary">
                <div class="form-group">
                    ...
                    {!!Form::select('nombreproyecto',$arrproy,'N',['class'=>'form-control
                    select2','autofocus','style'=>'width:100%;','id'=>'nombreproyecto'])!!}
                </div>
                <div class="form-group">
        ...
        <section class="card">
            ...
            <div class="card-body text-secondary" id="posdet2">
                ...
                <div class="box-footer">
                    <button type="button" class="btn btn-primary" onclick="ingresaractividades();" id="ingresar"
                        disabled='true'>Ingresar</button>
                    <button type="button" class="btn btn-primary" onclick="editaractividades();" id="actualizar"
...
<script type="text/javascript">
    ...
    $('#nombreproyecto').on('change', function () {
        ...
        $.get(pathname + '/getproyectos', {
            ...
            if (data.tr == 'gt') {
                ...
                var tc = '';
                table =
                    '<table id="grupotrabajo" class="table table-bordered table-striped table-hover" cellspacing="0" width="100%"></table>';
                ...
                var input =
                    '<input type="text" id="responsable" name="responsable" readonly class="form-control">';
                var inputh =
                    '<input type="hidden" id="responsablei" name="responsablei" readonly class="form-control">';
    ...
    function ingresaractividades() {
        ...
        if ($('#nombreact').val() == '' || $('#duracionact').val() == '') {
            ...
            $.post(pathname + '/ingresaractividad', {
                ids: id,
                userid: userid,
                nombreact: nombre,
                tipoactividad: tipoactividad,
                prioridad: prioridad,
                duracionact: duracion,
                tiempo: tiempo,
    ...
    function editaractividades() {
        if ($('#nombreact').val() == '' || $('#duracionact').val() == '') {
            ...
            $.post(pathname + '/editaractividad', {
                idactividad: ided,
                ids: id,
                userid: userided,
                nombreact: nombreed,
                tipoactividad: tipoactividaded,
                prioridad: prioridaded,
                duracionact: duracioned,
                tiempo: tiempoed,
                fechainicio: fechainicioed,
                idcabecera: idcabecera,
                tiporecurso: tiporecurso
            }, function () {}).done(function (data) {
