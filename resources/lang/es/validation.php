...
return [
	...
	*/
	...
	'custom' => [
        ...
        'confirmed' => 'El campo de confirmación de la Contraseña no coincide.',
    	'regex' => 'El formato de Contraseña es inválido.'],
        'genr_descripcion' => [
         ...
         'invope_email' => [
         'required'=>'El campo Email es obligatorio',
         'email'=>'El campo Email tiene un formato inválido'],
         'invope_cedula' => [
